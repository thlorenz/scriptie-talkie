...
window.normalizeModule = function(parentId, moduleName) {
    // normalize plugin acerequires
    if (moduleName.indexOf("!") !== -1) {
        var chunks = moduleName.split("!");
        return normalizeModule(parentId, chunks[0]) + "!" + normalizeModule(parentId, chunks[1]);
    }
    // normalize relative acerequires
...
window.acerequire = function(parentId, id) {
    if (!id.charAt)
        throw new Error("worker.js acerequire() accepts only (parentId, id) as arguments");

    id = normalizeModule(parentId, id);

    var module = acerequire.modules[id];
    if (module) {
    ...
    var chunks = id.split("/");
    chunks[0] = acerequire.tlns[chunks[0]] || chunks[0];
    var path = chunks.join("/") + ".js";
    
    acerequire.id = id;
    importScripts(path);
    return acerequire(parentId, id);    
};
...
window.define = function(id, deps, factory) {
    ...
    var req = function(deps, factory) {
        return acerequire(id, deps, factory);
    };

    acerequire.modules[id] = {
        factory: function() {
            var module = {
                exports: {}
            };
...
window.initBaseUrls  = function initBaseUrls(topLevelNamespaces) {
    acerequire.tlns = topLevelNamespaces;
};

window.initSender = function initSender() {

    var EventEmitter = acerequire(null, "ace/lib/event_emitter").EventEmitter;
    var oop = acerequire(null, "ace/lib/oop");
...
window.onmessage = function(e) {
    ...
    if (msg.command) {
        ...
        acerequire(null, "ace/lib/fixoldbrowsers");
        sender = initSender();
        var clazz = acerequire(null, msg.module)[msg.classname];
...
ace.define('ace/mode/javascript_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/javascript/jshint'], function(acerequire, exports, module) {


var oop = acerequire("../lib/oop");
var Mirror = acerequire("../worker/mirror").Mirror;
var lint = acerequire("./javascript/jshint").JSHINT;
...
ace.define('ace/worker/mirror', ['require', 'exports', 'module' , 'ace/document', 'ace/lib/lang'], function(acerequire, exports, module) {
...
ace.define('ace/mode/javascript/jshint', ['require', 'exports', 'module' ], function(acerequire, exports, module) {
...
var JSHINT = (function () {
	...
	var anonname,		// The guessed name for anonymous functions.
		...
		boolOptions = {
			...
			camelcase	: true, // if identifiers should be acerequired in camel case
			couch		: true, // if CouchDB globals should be predefined
			curly		: true, // if curly braces around all blocks should be acerequired
			debug		: true, // if debugger statements should be allowed
			devel		: true, // if logging globals should be predefined (console,
			dojo		: true, // if Dojo Toolkit globals should be predefined
			eqeqeq		: true, // if === should be acerequired
			...
			strict		: true, // acerequire the  pragma
